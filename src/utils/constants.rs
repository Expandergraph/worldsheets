// Messages
pub const _MESSAGE_OK: &str = "ok";
pub const _MESSAGE_CAN_NOT_DELETE_DATA: &str = "Can not delete data";
pub const _MESSAGE_CAN_NOT_FETCH_DATA: &str = "Can not fetch data";
pub const _MESSAGE_CAN_NOT_INSERT_DATA: &str = "Can not insert data";
pub const _MESSAGE_CAN_NOT_UPDATE_DATA: &str = "Can not update data";
...
pub const _MESSAGE_SIGNUP_FAILED: &str = "Error while signing up, please try again";
